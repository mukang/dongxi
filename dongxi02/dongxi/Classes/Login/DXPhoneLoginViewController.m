...
- (void)setupContentView {
    ...
    phoneUnderLine.backgroundColor = DXRGBColor(188, 188, 188);
    ...
    passwordF.attributedPlaceholder = [self attributedWithString:@"请输入密码" color:DXRGBColor(177, 177, 177)];
...
- (void)login {
    ...
    userLoginInfo.account_type = DXUserLoginAccountTypeMobile;
