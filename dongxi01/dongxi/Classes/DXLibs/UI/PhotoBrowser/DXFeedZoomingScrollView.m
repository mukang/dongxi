...
@implementation DXFeedZoomingScrollView {
    
    DXFeedPhotoBrowser __weak *_photoBrowser;
    DXFeedTapDetectingView *_tapView; // for background taps
    DXFeedTapDetectingImageView *_photoImageView;
...
- (id)initWithPhotoBrowser:(DXFeedPhotoBrowser *)browser {
    if (self = [super init]) {
        ...
        _tapView = [[DXFeedTapDetectingView alloc] initWithFrame:self.bounds];
        ...
        // Image view
        _photoImageView = [[DXFeedTapDetectingImageView alloc] initWithFrame:CGRectZero];
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self
                                                 selector:@selector(setProgressFromNotification:)
                                                     name:DXPHOTO_PROGRESS_NOTIFICATION
                                                   object:nil];
...
- (void)setPhoto:(id<DXFeedPhoto>)photo {
...
- (void)setProgressFromNotification:(NSNotification *)notification {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        id <DXFeedPhoto> photoWithProgress = [dict objectForKey:@"photo"];
...
- (void)handleSingleTap:(CGPoint)touchPoint {
    [_photoBrowser performSelector:@selector(toggleDismiss) withObject:nil afterDelay:0.2];
}
