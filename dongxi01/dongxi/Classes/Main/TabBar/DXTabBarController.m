...
- (void)viewDidLoad {
    ...
    [self addOneChildViewController:[[DXHomeViewControllerV2 alloc] init] image:@"tab_home_normal" selectedImage:@"tab_home_click"];
    [self addOneChildViewController:[[DXDiscoverViewController alloc] init] image:@"tab_discover_normal" selectedImage:@"tab_discover_click"];
    [self addOneChildViewController:[[DXMessageViewController alloc] init] image:@"tab_news_normal" selectedImage:@"tab_news_click"];
    self.loginUserProfileController = [[DXProfileViewController alloc] initWithControllerType:DXProfileViewControllerLoginUser];
    [self addOneChildViewController:self.loginUserProfileController image:@"tab_profile_normal" selectedImage:@"tab_profile_click"];
...
- (void)addOneChildViewController:(UIViewController *)childController image:(NSString *)image selectedImage:(NSString *)selectedImage {
